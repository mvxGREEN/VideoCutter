...
import green.mobileapps.clippervideocutter.utils.UnitConverter;
import green.mobileapps.clippervideocutter.utils.device.DeviceUtil;
import green.mobileapps.clippervideocutter.utils.functions.Callback;
...
public class VideoTrimmerUtil {
  ...
  public static void trim(Context context, String inputFile, String outputFile, long startMs, long endMs, final VideoTrimListener callback) {
    ...
    try {
      ...
      /* TODO implement or remove ffmpeg
  ...
  public static void shootVideoThumbInBackground(final Context context, final Uri videoUri, final int totalThumbsCount, final long startPosition,
      final long endPosition, final Callback<Bitmap, Integer> callback) {
