package green.mobileapps.clippervideocutter.utils;

import static green.mobileapps.clippervideocutter.UtilEngine.getContext;
...
import green.mobileapps.clippervideocutter.BuildConfig;
    ...
    if (TextUtils.isEmpty(sDataDir)) {
      try {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
          ...
          if (TextUtils.isEmpty(sDataDir)) {
            sDataDir = getContext().getFilesDir().getAbsolutePath();
          }
        } else {
          sDataDir = getContext().getFilesDir().getAbsolutePath();
        }
