package green.mobileapps.clippervideocutter.widget;

import static green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil.MAX_SHOOT_DURATION;
import static green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil.THUMB_WIDTH;
import static green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
import green.mobileapps.clippervideocutter.features.trim.VideoTrimmerAdapter;
import green.mobileapps.clippervideocutter.features.trim.VideoTrimmerUtil;
import green.mobileapps.clippervideocutter.interfaces.IVideoTrimmerView;
import green.mobileapps.clippervideocutter.interfaces.VideoTrimListener;
import green.mobileapps.clippervideocutter.utils.StorageUtil;
import green.mobileapps.clippervideocutter.utils.thread.BackgroundExecutor;
import green.mobileapps.clippervideocutter.utils.thread.UiThreadExecutor;
